  ...
  function WoxUpload(props) {
    ...
    _this.handlePicChange = function (e) {
      ...
      if (e.file.status) {
        ...
        var notSimple = _this.state.notSimple;

        _this.setState({ fileList: list.length ? notSimple ? list : list.splice(-1) : [] });
      }
    };
    ...
    _this.triggerChange = function (list) {
      ...
      if (onChange) {
        ...
        onChange(notSimple ? list.map(function (val) {
          return val.url;
    ...
    _this.state = {
      ...
      notSimple: _this.props.notSimple ? true : false
    };
    return _this;
  }
  ...
  _createClass(WoxUpload, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        !notSimple && fileList.length ? _react2.default.createElement(
          'span',
